...
//function to display end of quiz and score
function showResult() {
    princessImageElement.src = "assets/images/belle.png";
    questionElement.textContent = "Quiz Completed!";
    optionsContainer.innerHTML = "";
    scoreElement.textContent = `Your Score: ${score} out of ${shuffledPrincesses.length}`;
